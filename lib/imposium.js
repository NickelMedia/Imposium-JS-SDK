...
var API = /** @class */ (function () {
    ...
    API.checkBandwidth = function () {
        ...
        var config = { responseType: 'blob', timeout: 2000 };
        return new Promise(function (resolve, reject) {
...
var ImposiumPlayer = /** @class */ (function (_super) {
    ...
    function ImposiumPlayer(node, client, config) {
         ...
         */
        _this.experienceGenerated = function (experience) {
            var _a = _this, experienceCache = _a.experienceCache, node = _a.node;
            ...
            var testPromises = [];
            var compression = compressionLevels.LOW;
            ...
            Promise.all(testPromises)
                ...
                var has1080 = (experience.hasOwnProperty(compressionLevels.HIGH));
