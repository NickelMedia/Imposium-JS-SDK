...
var MessageConsumer = /** @class */ (function () {
    ...
    MessageConsumer.prototype.init = function (config) {
        var _this = this;
        config.onError = this.onError = function (e) { return _this.errorHandler(e); };
     ...
     */
    MessageConsumer.prototype.startEventProcessor = function () {
        var body = {
     ...
     */
    MessageConsumer.prototype.errorHandler = function (err) {
        if (err.wasClean) {
     ...
     */
    MessageConsumer.prototype.gotMessage = function (data) {
        var update = data;
        if (update)
     ...
     * @param {any} data message body payload
     */
    MessageConsumer.prototype.gotScene = function (data) {
        var _this = this;
        var sceneData = null;
