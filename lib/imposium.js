...
var errorsShared = __webpack_require__(/*! ../conf/errors.json */ "./src/conf/errors.json").shared;
            ...
            try {
                if (Helpers_1.isFunc(callback)) {
                    if (Helpers_1.keyExists(_this.events, eventName)) {
                        ...
                        throw ExceptionPipe_1.default.createError({
                            type: 'configuration',
            ...
            try {
                if (gotExperience) {
                    API_1.default.getExperience(expId)
                        ...
                        .catch(function (e) {
                        var imposiumError = ExceptionPipe_1.default.createError({
                            type: 'network',
                    ...
                    throw ExceptionPipe_1.default.createError({
                        ...
                        runtimeProp: _this.events.GOT_EXPERIENCE
                    });
                }
            }
            catch (e) {
            ...
            try {
                if (permitRender || permitCreate) {
                    ...
                    postExperience(storyId, inventory, uploadProgress)
                        ...
                        ExceptionPipe_1.default.routeError(imposiumError);
                    });
                }
                else {
...
var ExceptionPipe_1 = __webpack_require__(/*! ../../scaffolding/ExceptionPipe */ "./src/scaffolding/ExceptionPipe.ts");
var Helpers_1 = __webpack_require__(/*! ../../scaffolding/Helpers */ "./src/scaffolding/Helpers.ts");
var errors = __webpack_require__(/*! ../../conf/errors.json */ "./src/conf/errors.json").messageConsumer;
...
/*!******************************!*\
  !*** ./src/conf/errors.json ***!
  \******************************/
/*! exports provided: environment, configuration, network, moderation, default */
/***/ (function(module) {

module.exports = {"environment":{"node":"Sorry, this feature is incompatible with NodeJS"},"configuration":{"invalidEventName":"[placeholder] is not a valid Imposium event, please review your configuration.","invalidCallbackType":"The callback reference set for event [placeholder] is not a function, please review your configuration.","eventNotConfigured":"Attempted to trigger an event without the required callback: [placeholder], please review your configuration.","invalidPlayerRef":"No reference to an HTML5 video element was detected, please review your configuration."},"network":{"httpFailure":"Unable to process request to the Imposium API.","tcpFailure":"Unable to reach Imposium while processing this experience.","errorOverTcp":"Something went wrong while processing this experience.","messageParseFailure":"Message data from Imposium was malformed."},"moderation":{"rejection":"This experience was rejected."}};
...
var ExceptionPipe = /** @class */ (function () {
    ...
    ExceptionPipe.stub = '[placeholder]';
    ...
    ExceptionPipe.createError = function (config) {
        var experienceId = config.experienceId, type = config.type, messageKey = config.messageKey, runtimeProp = config.runtimeProp, exception = config.exception;
        var imposiumError = { type: type, message: errors[type][messageKey] };
        if (runtimeProp) {
...
var ExceptionPipe_1 = __webpack_require__(/*! ../scaffolding/ExceptionPipe */ "./src/scaffolding/ExceptionPipe.ts");
var Helpers_1 = __webpack_require__(/*! ../scaffolding/Helpers */ "./src/scaffolding/Helpers.ts");
var errors = __webpack_require__(/*! ../conf/errors.json */ "./src/conf/errors.json").videoPlayer;
