...
var MessageConsumer = /** @class */ (function () {
    ...
    MessageConsumer.prototype.init = function () {
        ...
        Stomp_1.default.setHandlers(function () { _this.invokeStreaming(); }, function (msg) { return _this.router(msg); }, function (e) { return _this.streamError(e); });
...
var Stomp = /** @class */ (function () {
    ...
    Stomp.init = function (expId) {
        var isEnabled = Stomp.isEnabled, endpoint = Stomp.endpoint, username = Stomp.username, password = Stomp.password, onError = Stomp.onError;
        if (isEnabled) {
            Stomp.expId = expId;
            Stomp.socket = new WebSocket(endpoint);
            Stomp.client = WebStomp.over(Stomp.socket);
            Stomp.client.debug = function () { };
            Stomp.client.connect(username, password, function () { return Stomp.establishSubscription(); }, onError);
        }
        else {
