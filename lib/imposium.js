...
var ImposiumClient = /** @class */ (function () {
    ...
    function ImposiumClient(config) {
        ...
        this.getExperience = function (experienceId) {
            ...
            try {
                if (gotExperience) {
                    API_1.default.getExperience(experienceId)
                        .then(function (data) {
                    ...
                    throw new Exceptions_1.ClientConfigurationError('eventNotConfigured', _this.events.GOT_EXPERIENCE);
                }
            }
            catch (e) {
                ExceptionPipe_1.default.routeError(e);
...
var MessageConsumer = /** @class */ (function () {
    ...
    MessageConsumer.reconnect = function (job) {
        Stomp_1.default.disconnectAsync()
            ...
            var expId = MessageConsumer.job.expId;
            var wrappedError = new Exceptions_1.NetworkError('tcpFailure', expId, e);
            ExceptionPipe_1.default.routeError(wrappedError);
        });
    };
    /*
    ...
    MessageConsumer.invokeStreaming = function () {
        ...
        API_1.default.invokeStream(expId, sceneId, actId)
            .catch(function (e) {
            var wrappedError = new Exceptions_1.NetworkError('httpFailure', expId, e);
            ExceptionPipe_1.default.routeError(wrappedError);
        });
    };
    /*
    ...
    MessageConsumer.routeMessageData = function (msg) {
        ...
        try {
            ...
            var expId = MessageConsumer.job.expId;
            var wrappedError = new Exceptions_1.NetworkError('messageParseFailed', expId, e);
            ExceptionPipe_1.default.routeError(wrappedError);
        }
    };
    /*
    ...
    MessageConsumer.emitMessageData = function (messageData) {
        ...
        try {
            if (msg === settings.errorOverTcp) {
                var expId = MessageConsumer.job.expId;
                throw new Exceptions_1.NetworkError('errorOverTcp', expId, null);
            }
            if (statusUpdate) {
        ...
        try {
            if (!rejected) {
                ...
                if (isVideo && hasUrls) {
                    ...
                    var expId = MessageConsumer.job.expId;
                    throw new Exceptions_1.NetworkError('messageParseFailed', expId, null);
                }
            }
            else {
...
module.exports = {"environment":{"node":"Sorry, this feature is incompatible with NodeJS"},"moderation":{"rejection":"This experience was rejected."},"clientConfiguration":{"invalidEventName":"Invalid Imposium event, please review your configuration.","invalidCallbackType":"You did not pass in a function reference for this event, please review your configuration.","eventNotConfigured":"You cannot invoke this event without a callback set, please review your configuration."},"playerConfiguration":{"invalidPlayerRef":"No reference to an HTML5 video element was detected, please review your configuration."},"network":{"httpFailure":"Unable to process request to the Imposium API.","tcpFailure":"Unable to reach Imposium while processing this experience.","errorOverTcp":"Something went wrong while processing this experience.","messageParseFailure":"Message data from Imposium was malformed."}};
