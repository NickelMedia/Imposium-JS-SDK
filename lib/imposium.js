...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/ImposiumClient.ts");
/******/ })
/************************************************************************/
/******/ ({
...
Object.defineProperty(exports, "__esModule", { value: true });
var Analytics_1 = __webpack_require__(/*! ./Analytics */ "./src/Analytics.ts");
var apisauce_1 = __webpack_require__(/*! apisauce */ "./node_modules/apisauce/dist/apisauce.js");
    ...
    API.getExperience = function (expId) {
        ...
        return new Promise(function (resolve, reject) {
            get("/experience/" + expId)
                .then(function (res) {
                var ok = res.ok, data = res.data, status = res.status;
                if (ok) {
                    resolve(data);
                }
                else {
...
var ImposiumEvents_1 = __webpack_require__(/*! ./ImposiumEvents */ "./src/ImposiumEvents.ts");
...
var ImposiumEvents_1 = __webpack_require__(/*! ./ImposiumEvents */ "./src/ImposiumEvents.ts");
var MessageConsumer_1 = __webpack_require__(/*! ./MessageConsumer */ "./src/MessageConsumer.ts");
var Helpers_1 = __webpack_require__(/*! ./Helpers */ "./src/Helpers.ts");
