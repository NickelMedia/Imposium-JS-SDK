...
var _curry1 = __webpack_require__(11);
var _curry2 = __webpack_require__(9);
var _curryN = __webpack_require__(415);
...
var _isArrayLike = __webpack_require__(404);
var _xwrap = __webpack_require__(405);
...
var _curry2 = __webpack_require__(9);
var _dispatchable = __webpack_require__(423);
var _map = __webpack_require__(425);
var _reduce = __webpack_require__(71);
var _xmap = __webpack_require__(426);
...
var MessageConsumer_1 = __webpack_require__(396);
var API_1 = __webpack_require__(149);
var VideoPlayer_1 = __webpack_require__(453);
...
var ImposiumClient = /** @class */ (function () {
    ...
    function ImposiumClient(token, config) {
         ...
         */
        this.getStory = function (storyId, success, error) {
        ...
        /*
            Get experience data
         */
        this.getExperience = function (expId, success, error) {
         ...
         */
        this.createExperience = function (storyId, inventory, render, success, error, progress) {
            if (progress === void 0) { progress = null; }
            API_1.default.postExperience(storyId, inventory, progress)
                .then(function (data) {
                var id = data.id;
                Analytics_1.default.send({
                    t: 'event',
    ...
    ImposiumClient.prototype.getVideo = function (job, success, error) {
        ...
        if (!this.messageConsumer) {
            this.messageConsumer = new MessageConsumer_1.MessageConsumer(jobSpec, this);
        }
        else {
...
Object.defineProperty(exports, "__esModule", { value: true });
var apisauce_1 = __webpack_require__(399);
var Helpers_1 = __webpack_require__(449);
var jwt_decode = __webpack_require__(450);
var API = /** @class */ (function () {
    ...
    API.postExperience = function (storyId, inventory, progress) {
        if (progress === void 0) { progress = null; }
        var data = Helpers_1.formatInventory(storyId, inventory);
...
var _curry2 = __webpack_require__(9);
var _equals = __webpack_require__(432);
...
var isValue = __webpack_require__(102);
...
Object.defineProperty(exports, "__esModule", { value: true });
var ImposiumClient_1 = __webpack_require__(74);
var Stomp_1 = __webpack_require__(397);
var API_1 = __webpack_require__(149);
var MessageConsumer = /** @class */ (function () {
    function MessageConsumer(job, delegate) {
        this.retried = 0;
        this.maxRetries = 5;
        this.job = job;
    ...
    MessageConsumer.prototype.init = function () {
        ...
        Stomp_1.default.setHandlers(function () { _this.invokeStreaming(); }, function (msg) { return _this.routeMessageData(msg); }, function (e) { return _this.streamError(e); });
        Stomp_1.default.init(expId);
    };
    /*
        Sets up a websocket for the experience
     */
    MessageConsumer.prototype.reconnect = function () {
        var _this = this;
        Stomp_1.default.kill()
            .then(function () {
            _this.init();
        }).catch(function (err) {
    ...
    MessageConsumer.prototype.observer = function () {
    ...
    MessageConsumer.prototype.gotScene = function (payload) {
        var _a = this.job, onSuccess = _a.onSuccess, onError = _a.onError;
        ...
        if (onSuccess && onError) {
            var rejected = (payload || {}).error;
            if (!rejected) {
                // Shorthand idioms for checking if required nested JSON data exists
                var isVideo = (((payload || {}).sceneData || {}).type === 'VideoScene01');
                var sceneId = ((payload || {}).sceneData || {}).id;
                var hasUrls = (((payload || {}).output || {})[sceneId] || {}).mp4Url;
                if (isVideo && hasUrls) {
                    var id = payload.id, output = payload.output;
...
Object.defineProperty(exports, "__esModule", { value: true });
var WebStomp = __webpack_require__(398);
...
var Stomp = /** @class */ (function () {
    ...
    // Handlers / Callbacks
    Stomp.triggerEmit = null;
    Stomp.onMessage = null;
    Stomp.onError = null;
    // Set based on if handlers are established
    Stomp.isEnabled = false;
    /*
        Setup callbacks
     */
    Stomp.setHandlers = function (triggerEmit, onMessage, onError) {
    ...
    Stomp.init = function (expId) {
        var isEnabled = Stomp.isEnabled, endpoint = Stomp.endpoint, username = Stomp.username, password = Stomp.password, onError = Stomp.onError, establishSubscription = Stomp.establishSubscription;
        if (isEnabled) {
            Stomp.expId = expId;
    ...
    Stomp.establishSubscription = function () {
        var exchange = Stomp.exchange, expId = Stomp.expId, onMessage = Stomp.onMessage, triggerEmit = Stomp.triggerEmit;
...
var _concat = __webpack_require__(150);
var _createPartialApplicator = __webpack_require__(401);
...
var _arity = __webpack_require__(49);
var _pipe = __webpack_require__(403);
var reduce = __webpack_require__(104);
var tail = __webpack_require__(407);
...
var _curry1 = __webpack_require__(11);
var _isArray = __webpack_require__(72);
var _isString = __webpack_require__(151);
...
var _checkForMethod = __webpack_require__(105);
var _curry1 = __webpack_require__(11);
var slice = __webpack_require__(408);
...
var lift = __webpack_require__(420);
var not = __webpack_require__(428);
...
var _curry1 = __webpack_require__(11);
var liftN = __webpack_require__(421);
...
var _curry2 = __webpack_require__(9);
var _reduce = __webpack_require__(71);
var ap = __webpack_require__(422);
var curryN = __webpack_require__(55);
...
var _isArray = __webpack_require__(72);
var _isTransformer = __webpack_require__(424);
...
var _curry2 = __webpack_require__(9);
var _xfBase = __webpack_require__(427);
...
var _curry1 = __webpack_require__(11);
var empty = __webpack_require__(430);
...
var _isArguments = __webpack_require__(152);
var _isArray = __webpack_require__(72);
var _isObject = __webpack_require__(431);
var _isString = __webpack_require__(151);
...
var _arrayFromIterator = __webpack_require__(433);
var _functionName = __webpack_require__(434);
var _has = __webpack_require__(54);
var identical = __webpack_require__(435);
var keys = __webpack_require__(106);
...
var _curry1 = __webpack_require__(11);
var curryN = __webpack_require__(55);
var max = __webpack_require__(157);
var pluck = __webpack_require__(438);
var reduce = __webpack_require__(104);
...
var _curry2 = __webpack_require__(9);
var map = __webpack_require__(73);
var prop = __webpack_require__(153);
...
var _contains = __webpack_require__(440);
var _curry2 = __webpack_require__(9);
...
var _indexOf = __webpack_require__(441);
...
var always = __webpack_require__(154);
...
exports.formatInventory = function (storyId, inventory) {
...
exports.errorHandler = function (message, error) {
...
var base64_url_decode = __webpack_require__(451);
...
var atob = __webpack_require__(452);
