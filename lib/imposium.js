...
var _curry1 = __webpack_require__(1);
var _curry2 = __webpack_require__(0);
var _curryN = __webpack_require__(53);
...
var _isArrayLike = __webpack_require__(42);
...
var _curry2 = __webpack_require__(0);
var _dispatchable = __webpack_require__(61);
var _map = __webpack_require__(63);
var _reduce = __webpack_require__(8);
var _xmap = __webpack_require__(64);
...
var _isArguments = __webpack_require__(20);
...
var _undefined = __webpack_require__(125)(); // Support ES3 engines
...
const apisauce_1 = __webpack_require__(37);
const EventEmitter = __webpack_require__(117);
// import * as FormData from 'form-data';
const MessageConsumer_1 = __webpack_require__(133);
class events {
}
events.STATUS = "imposium_status_update";
exports.events = events;
class ImposiumClient {
    /**
     ...
     */
    getStory(storyId, success, error) {
     ...
     * @param {any)=>void} error   error callback
     */
    getExperience(expId, success, error) {
     ...
     */
    createExperience(storyId, inventory, render, success, error, progress = null) {
        const data = this.formatData(storyId, inventory, error), config = (progress) ? { onUploadProgress: (e) => progress(e) } : {};
     ...
     */
    formatData(storyId, inventory, error) {
...
var _createPartialApplicator = __webpack_require__(39);
...
var tail = __webpack_require__(45);
...
var not = __webpack_require__(66);
...
var _curry2 = __webpack_require__(0);
var _xfBase = __webpack_require__(65);
...
var _arrayFromIterator = __webpack_require__(71);
var _functionName = __webpack_require__(72);
var _has = __webpack_require__(5);
...
var d        = __webpack_require__(118)
  , callable = __webpack_require__(132)
...
var assign        = __webpack_require__(119)
  ...
  , contains      = __webpack_require__(129)
...
Object.defineProperty(exports, "__esModule", { value: true });
const ImposiumClient_1 = __webpack_require__(17);
const StompClient_1 = __webpack_require__(134);
/**
...
class MessageConsumer {
     ...
     */
    constructor(job, config, delegate, api) {
        this.retried = 0;
        this.maxRetries = 3;
        this.job = job;
     ...
     */
    init(config) {
        config.onError = this.onError = (e) => this.streamError(e);
    ...
    invokeStreaming() {
        ...
        const endpoint = `/experience/${this.job.expId}/trigger-event`, body = { expId: this.job.expId, actId: this.job.actId };
        this.api.post(endpoint, body)
            .then(res => {
            if (!res.ok)
                this.delegate.onError = (() => this.job.onError(res.data))();
        });
    }
    /**
        ...
        if (payload.output[payload.sceneData.id].mp4Url) {
            ...
            if (sceneData != null) {
                if (this.job.onSuccess) {
                    this.delegate.onError = (() => this.job.onSuccess(sceneData))();
                }
            }
            else {
                if (this.job.onError) {
                    this.delegate.onSuccess = (() => this.job.onError(sceneData))();
                }
            }
        }
    }
    ...
    streamError(err) {
        if (!err.wasClean) {
            ...
            if (this.retried < this.maxRetries) {
                ...
                this.delegate.onError = (() => this.job.onError(err))();
            }
        }
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const WebStomp = __webpack_require__(135);
/**
...
class StompClient {
    ...
    init() {
        ...
        this.client.debug = () => { };
        this.client.connect(this.config.user, this.config.password, this.subscribe = () => this.establishSubscription(), this.config.onError);
    }
    /**
