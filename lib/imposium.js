...
var VideoRetriever_1 = __webpack_require__(52);
...
var ImposiumClient = /** @class */ (function () {
    ...
    ImposiumClient.prototype.startEventProcessor = function (data, success, error) {
        if (!this.videoRetriever) {
            ...
            this.videoRetriever = new VideoRetriever_1.default(config, this);
        }
        else {
...
var VideoRetriever = /** @class */ (function () {
    function VideoRetriever(data, delegate) {
        var _this = this;
        this.stompConfig = {
     ...
     */
    VideoRetriever.prototype.stompConnectionHandler = function () {
        var _this = this;
        this.stompClient.subscribe(this.stompConfig.subscription, this.stompOnMessage = function (msg) { return _this.stompMessageHandler(msg); });
    };
    /**
     * Route incoming stomp message payload
     * @param {Obj} msg rabbitMQ/stomp message object
     */
    VideoRetriever.prototype.stompMessageHandler = function (msg) {
    ...
    VideoRetriever.prototype.stompErrorHandler = function (err) {
     ...
     * handlers
     */
    VideoRetriever.prototype.createSocket = function () {
        var _this = this;
     ...
     */
    VideoRetriever.prototype.connected = function () {
        var _this = this;
        clearTimeout(this.connectionTimeout);
     ...
     */
    VideoRetriever.prototype.startEventProcessor = function () {
        var _this = this;
        var data = {
            'expId': this.data.exp,
            'actId': this.data.act,
        ...
        this.stompClient.connect(this.stompConfig.username, this.stompConfig.password, this.stompOnConnect = function () { return _this.stompConnectionHandler(); }, this.stompOnError = function (e) { return _this.stompErrorHandler(e); });
     ...
     */
    VideoRetriever.prototype.updateMessage = function (data) {
        var update = data;
        if (update)
            this.delegate.emit(ImposiumClient_1.events.STATUS, update);
    };
    VideoRetriever.prototype.reconnect = function (id) {
        var _this = this;
        if (!this.error) {
            this.data.exp = id;
            this.startEventProcessor();
            ...
            if (this.data.onError) {
                this.delegate = function (e) { return _this.data.onError(e); };
                this.delegate();
            }
        }
    };
     ...
     */
    VideoRetriever.prototype.gotScene = function (data) {
        var _this = this;
        var sceneData = null;
        this.waitingForVideo = false;
        clearTimeout(this.renderTimeout);
        ...
        if (sceneData != null) {
            if (this.data.onSuccess) {
                this.delegate = function () { return _this.data.onSuccess(sceneData); };
                this.delegate();
            }
        }
        else {
            if (this.data.onError) {
                this.delegate = function () { return _this.data.onError(sceneData); };
                this.delegate();
            }
        }
    };
     ...
     */
    VideoRetriever.prototype.socketError = function (invId) {
        var _this = this;
        this.error = true;
        clearTimeout(this.connectionTimeout);
        clearTimeout(this.renderTimeout);
        if (this.data.onError) {
            this.delegate = function () { return _this.data.onError(invId); };
            this.delegate();
        }
    };
    /**
     ...
     */
    VideoRetriever.prototype.killSocket = function () {
        if (this.socket) {
...
exports.default = VideoRetriever;
