...
var ImposiumClient = /** @class */ (function () {
    ...
    function ImposiumClient(config) {
        ...
        this.eventDelegateRefs = Helpers_1.cloneWithKeys(this.events);
        this.api = null;
        this.player = null;
        this.consumer = null;
        ...
        this.startMessaging = function (experienceId) {
            var _a = _this, api = _a.api, _b = _a.clientConfig, actId = _b.actId, sceneId = _b.sceneId, ERROR = _a.eventDelegateRefs.ERROR;
        ...
        this.getExperience = function (experienceId) {
            var _a = _this, api = _a.api, player = _a.player, _b = _a.eventDelegateRefs, GOT_EXPERIENCE = _b.GOT_EXPERIENCE, ERROR = _b.ERROR;
            try {
        ...
        this.createExperience = function (inventory, render) {
            ...
            var _a = _this, player = _a.player, _b = _a.eventDelegateRefs, GOT_EXPERIENCE = _b.GOT_EXPERIENCE, EXPERIENCE_CREATED = _b.EXPERIENCE_CREATED, UPLOAD_PROGRESS = _b.UPLOAD_PROGRESS, ERROR = _b.ERROR;
            var permitRender = (render && (player || EXPERIENCE_CREATED));
            var permitCreate = (!render && GOT_EXPERIENCE);
            try {
...
var MessageConsumer = /** @class */ (function () {
    function MessageConsumer(env, experienceId, clientDelegates, player) {
        ...
        this.emitMessageData = function (messageData) {
            var _a = _this, experienceId = _a.experienceId, _b = _a.clientDelegates, STATUS_UPDATE = _b.STATUS_UPDATE, ERROR = _b.ERROR;
        ...
        this.emitSceneData = function (experienceData) {
            var _a = _this, experienceId = _a.experienceId, _b = _a.clientDelegates, GOT_EXPERIENCE = _b.GOT_EXPERIENCE, ERROR = _b.ERROR;
...
exports.cloneWithKeys = function (o) {
    return Object.keys(o).reduce(function (p, c) {
        p[c] = null;
        return p;
    }, {});
};
