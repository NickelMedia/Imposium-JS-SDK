...
var ImposiumClient = /** @class */ (function () {
    ...
    function ImposiumClient(config) {
        ...
        this.getExperience = function (experienceId) {
            var _a = _this, api = _a.api, player = _a.player;
        ...
        this.renderExperience = function (job) {
            var _a = _this, consumer = _a.consumer, player = _a.player, environment = _a.clientConfig.environment;
            var startDelegate = function (j) { return _this.startMessaging(j); };
            if (!consumer) {
                _this.consumer = new MessageConsumer_1.default(job, environment, startDelegate, player);
            }
            else {
                consumer.kill()
                    .then(function () {
        ...
        this.captureAnalytics = function (playerRef) {
            ...
            try {
                if (!Helpers_1.isNode()) {
                    _this.setPlayer(new FallbackPlayer_1.default(playerRef));
                }
                else {
...
var MessageConsumer = /** @class */ (function () {
    function MessageConsumer(job, env, startDelegate, player) {
        var _this = this;
        this.delegates = {
...
var FallbackPlayer = /** @class */ (function (_super) {
    ...
    function FallbackPlayer(node) {
        ...
        _this.experienceGenerated = function (video, poster) {
...
var VideoPlayer = /** @class */ (function () {
    ...
    function VideoPlayer(node) {
         ...
         */
        this.experienceGenerated = function (v, p) {
            if (p === void 0) { p = ''; }
        };
        /*
