...
var ImposiumClient = /** @class */ (function () {
    ...
    function ImposiumClient(config) {
        ...
        this.startMessaging = function (job) {
            var api = _this.api;
            var expId = job.expId, sceneId = job.sceneId, actId = job.actId;
...
var MessageConsumer = /** @class */ (function () {
    function MessageConsumer(job, env, startDelegate, doCacheVideo) {
        ...
        this.startConsuming = function () {
            var _a = _this, job = _a.job, startDelegate = _a.startDelegate;
            startDelegate(job);
        };
        /*
            ...
            try {
                if (!rejected) {
                    ...
                    if (isVideo && hasUrls) {
                        ...
                        delete sceneData.id;
                        // START STUB
                        var mp4_720 = sceneData.videoUrls.mp4_720, experience_id = sceneData.experience_id;
                        if (_this.cacheVideo) {
                            _this.cacheVideo({
                                id: experience_id,
                                url: mp4_720,
