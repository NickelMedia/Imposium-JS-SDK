...
var ImposiumClient = /** @class */ (function () {
    function ImposiumClient(token, config) {
        ...
        this.xhrBaseURL = 'https://api.imposium.com/';
        EventEmitter(this);
        //set access token
        this.token = token;
    ...
    ImposiumClient.prototype.startEventProcessor = function (data, success, error) {
        ...
        if (!this.videoRetriever) {
            this.videoRetriever = new VideoRetriever_1.default(jobSpec, this, this.stompConfig);
        }
        else {
...
var VideoRetriever = /** @class */ (function () {
    function VideoRetriever(job, delegate, config) {
        this.job = job;
     ...
     */
    VideoRetriever.prototype.init = function (config) {
        var _this = this;
        ...
        this.stompClient = new StompClient_1.default(config);
    };
    /**
     * Updates relevant job details
     * @param {obj} data object containing job details
     */
    VideoRetriever.prototype.setJob = function (job) {
        this.job = job;
    };
    /**
     ...
     */
    VideoRetriever.prototype.router = function (msg) {
        console.log(msg);
     ...
     */
    VideoRetriever.prototype.errorHandler = function (err) {
        if (err.wasClean) {
     ...
     */
    VideoRetriever.prototype.gotMessage = function (data) {
        var update = data;
        if (update)
...
var StompClient = /** @class */ (function () {
    ...
    StompClient.prototype.establishSubscription = function () {
        this.client.subscribe(this.config.exchangeRoute, this.config.onMessage);
    };
