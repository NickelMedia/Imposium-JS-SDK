...
var MessageConsumer = /** @class */ (function () {
    ...
    MessageConsumer.cacheVideo = null;
    /*
        Initialize WebStomp
     */
    MessageConsumer.init = function (job, cacheVideo) {
        if (cacheVideo === void 0) { cacheVideo = null; }
     ...
     */
    MessageConsumer.reconnect = function (job, cacheVideo) {
        if (cacheVideo === void 0) { cacheVideo = null; }
    ...
    function ImposiumPlayer(node, client, config) {
        ...
        _this.init = function (config) {
            ...
            for (var key in ImposiumPlayer.ImposiumPlayerConfig) {
                _this.node[key] = ImposiumPlayer.ImposiumPlayerConfig[key];
            }
        };
        /*
    ...
    function VideoPlayer(node) {
        ...
        if (!Helpers_1.isNode()) {
            if (node instanceof HTMLVideoElement) {
                ...
                this.node = node;
                for (var key in Object.keys(mediaEvents)) {
