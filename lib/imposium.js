            ...
            try {
                if (gotExperience) {
                    API_1.default.getExperience(experienceId)
                        ...
                        ExceptionPipe_1.default.trapError(wrappedError);
                    });
                }
                else {
...
module.exports = {"environment":{"node":"Sorry, this feature is incompatible with NodeJS"},"moderation":{"rejection":"This experience was rejected."},"clientConfiguration":{"invalidEventName":"Invalid client event name.","invalidCallbackType":"The callback reference set for this client event is not of type function.","eventNotConfigured":"You cannot invoke this client event without a callback set."},"playerConfiguration":{"invalidPlayerRef":"No reference to an HTML5 video element was detected.","invalidEventName":"Invalid player event name.","invalidCallbackType":"The callback reference set for this player event is not of type function.","eventNotConfigured":"You cannot invoke this player event without a callback set."},"network":{"httpFailure":"Unable to process request to the Imposium API.","tcpFailure":"Unable to reach Imposium while processing this experience.","errorOverTcp":"Something went wrong while processing this experience.","messageParseFailure":"Message data from Imposium was malformed."}};
...
var ExceptionPipe = /** @class */ (function () {
    ...
    ExceptionPipe.trapError = function (e, breakFlow) {
...
throw new Error("Module build failed (from ./node_modules/awesome-typescript-loader/dist/entry.js):\nError: ENOENT: no such file or directory, open '/Users/patrickchisholm/Documents/work/Imposium-JS-SDK/src/video/Playback.ts'");
...
var VideoPlayer = /** @class */ (function () {
    ...
    function VideoPlayer(node) {
        ...
        this.onLoad = function () {
            var experienceId = VideoPlayer.experienceId;
        ...
        this.onPlay = function () {
            var intervalRate = VideoPlayer.intervalRate, playbackInterval = VideoPlayer.playbackInterval;
            clearInterval(playbackInterval);
            VideoPlayer.playbackInterval = setInterval(function () { return _this.checkPlayback(); }, intervalRate);
        };
        this.onPause = function () {
            var playbackInterval = VideoPlayer.playbackInterval;
            clearInterval(playbackInterval);
        };
        this.onEnd = function () {
            var experienceId = VideoPlayer.experienceId, playbackInterval = VideoPlayer.playbackInterval;
            clearInterval(playbackInterval);
            Analytics_1.default.send({
                t: 'event',
                ec: 'video_player',
        ...
        this.checkPlayback = function () {
            var node = VideoPlayer.node, playbackEvents = VideoPlayer.playbackEvents, prevPlaybackEvent = VideoPlayer.prevPlaybackEvent, experienceId = VideoPlayer.experienceId, playbackInterval = VideoPlayer.playbackInterval;
            if (node) {
