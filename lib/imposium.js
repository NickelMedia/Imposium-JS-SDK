...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/client/ImposiumClient.ts");
/******/ })
/************************************************************************/
/******/ ({
...
var Events_1 = __webpack_require__(/*! ../scaffolding/Events */ "./src/scaffolding/Events.ts");
...
var ImposiumClient = /** @class */ (function () {
    ...
    function ImposiumClient(config) {
        ...
        this.on = function (eventName, callback) {
            try {
                if (Helpers_1.isFunc(callback)) {
                    if (Helpers_1.keyExists(exports.Events, eventName)) {
        ...
        this.off = function (eventName) {
            ...
            try {
                if (eventName !== '') {
                    ...
                    Object.keys(exports.Events).forEach(function (event) {
        ...
        this.getExperience = function (expId) {
            ...
            try {
                if (gotExperience) {
                    ...
                    throw new Error(Helpers_1.formatError(noCallbackSet, exports.Events.GOT_EXPERIENCE));
                }
            }
            catch (e) {
                Helpers_1.errorHandler(e);
        ...
        this.createExperience = function (inventory, render) {
            var gotExperience = Events_1.default.gotExperience, experienceCreated = Events_1.default.experienceCreated, uploadProgress = Events_1.default.uploadProgress;
            ...
            try {
                if (permitRender || permitCreate) {
                    ...
                    if (render && !gotExperience) {
                        eventType = exports.Events.GOT_EXPERIENCE;
                    }
                    if (!render && !experienceCreated) {
                        eventType = exports.Events.EXPERIENCE_CREATED;
                    }
        ...
        this.captureAnalytics = function (playerRef) {
            ...
            try {
                if (!Helpers_1.isNode()) {
                    if (playerRef) {
                        FallbackPlayer_1.default.setup(playerRef);
                    }
                    else {
                        // throw no ref err
                    }
...
var Events_1 = __webpack_require__(/*! ./Events */ "./src/scaffolding/Events.ts");
// Log out warnings
...
var FallbackPlayer = /** @class */ (function () {
    function FallbackPlayer() {
    }
    FallbackPlayer.ref = null;
    /*
        Set up fallback analytics scenario for non Imposium video player refs
     */
    FallbackPlayer.setup = function (ref) {
        if (ref instanceof HTMLVideoElement) {
            FallbackPlayer.ref = ref;
            Playback_1.default.setPlayerRef(FallbackPlayer.ref);
        }
        else {
