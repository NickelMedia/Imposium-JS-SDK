...
var ImposiumClient = /** @class */ (function () {
    ...
    function ImposiumClient(config) {
        ...
        this.startMessaging = function (experienceId) {
            var _a = _this, api = _a.api, _b = _a.clientConfig, actId = _b.actId, sceneId = _b.sceneId, onError = _a.eventDelegateRefs.onError;
            api.invokeStream(experienceId, actId, sceneId)
                .catch(function (e) {
                var wrappedError = new Exceptions_1.NetworkError('httpFailure', experienceId, e);
                ExceptionPipe_1.default.trapError(wrappedError, onError);
            });
        };
        /*
        ...
        this.makeConsumer = function (experienceId) {
            ...
            var delegates = __assign({ start: function (experienceId) { return _this.startMessaging; } }, eventDelegateRefs);
        ...
        this.on = function (eventName, callback) {
            var _a = _this, eventDelegateRefs = _a.eventDelegateRefs, onError = _a.eventDelegateRefs.onError;
            try {
                ...
                ExceptionPipe_1.default.trapError(e, onError);
            }
        };
        /*
        ...
        this.getExperience = function (experienceId) {
            var _a = _this, api = _a.api, player = _a.player, _b = _a.eventDelegateRefs, gotExperience = _b.gotExperience, onError = _b.onError;
            try {
                if (gotExperience) {
        ...
        this.createExperience = function (inventory, render) {
            var _a = _this.eventDelegateRefs, gotExperience = _a.gotExperience, experienceCreated = _a.experienceCreated, uploadProgress = _a.uploadProgress, onError = _a.onError;
            var permitRender = (render && experienceCreated);
            var permitCreate = (!render && gotExperience);
            try {
                if (permitRender || permitCreate) {
                    var _b = _this, api = _b.api, storyId = _b.clientConfig.storyId;
        ...
        this.captureAnalytics = function (playerRef) {
            ...
            var onError = _this.eventDelegateRefs.onError;
            try {
                if (!Helpers_1.isNode()) {
...
var MessageConsumer = /** @class */ (function () {
    function MessageConsumer(env, experienceId, clientDelegates, player) {
        ...
        this.routeMessageData = function (msg) {
            ...
            var _b = _this, stomp = _b.stomp, experienceId = _b.experienceId, onError = _b.clientDelegates.onError;
            try {
        ...
        this.emitMessageData = function (messageData) {
            var _a = _this, experienceId = _a.experienceId, _b = _a.clientDelegates, statusUpdate = _b.statusUpdate, onError = _b.onError;
            var msg = messageData.msg;
            try {
                if (msg === settings.errorOverTcp) {
                    throw new Exceptions_1.NetworkError('errorOverTcp', experienceId, null);
                }
                if (statusUpdate) {
        ...
        this.emitSceneData = function (experienceData) {
            var _a = _this, experienceId = _a.experienceId, _b = _a.clientDelegates, gotExperience = _b.gotExperience, onError = _b.onError;
            ...
            try {
                if (!rejected) {
                    ...
                    if (isVideo && hasUrls) {
                        ...
                        throw new Exceptions_1.NetworkError('messageParseFailed', experienceId, null);
                    }
                }
                else {
        ...
        this.stompError = function (e) {
            var _a = _this, retried = _a.retried, experienceId = _a.experienceId, stomp = _a.stomp, onError = _a.clientDelegates.onError;
