            ...
            try {
                if (Helpers_1.isFunc(callback)) {
                    if (Helpers_1.keyExists(_this.events, eventName)) {
                        ...
                        var invalidEvent = errors.invalidEvent;
                        throw new Error(Helpers_1.formatError(invalidEvent, eventName));
                    }
                }
                else {
                    var badEventRef = errors.badEventRef;
                    throw new Error(Helpers_1.formatError(badEventRef, eventName));
                }
            }
            catch (e) {
        ...
        this.getExperience = function (expId) {
            ...
            try {
                if (gotExperience) {
                    ...
                    throw new Error(Helpers_1.formatError(noCallbackSet, _this.events.GOT_EXPERIENCE));
                }
            }
            catch (e) {
                Helpers_1.errorHandler(e);
        ...
        this.createExperience = function (inventory, render) {
            ...
            try {
                if (permitRender || permitCreate) {
                    ...
                    throw new Error(Helpers_1.formatError(noCallbackSet, eventType));
                }
            }
            catch (e) {
                Helpers_1.errorHandler(e);
        ...
        this.captureAnalytics = function (playerRef) {
            ...
            try {
                if (!Helpers_1.isNode()) {
                    ...
                    var nodeAnalytics = warnings.nodeAnalytics;
                    Helpers_1.warnHandler(nodeAnalytics);
                }
            }
            catch (e) {
    ...
    MessageConsumer.emitMessageData = function (messageData) {
        ...
        try {
            if (msg === settings.errorOverTcp) {
                var serverFailed = errors.serverFailed;
        ...
        try {
            if (!rejected) {
                ...
                if (isVideo && hasUrls) {
                    ...
                    var parseFailed = errors.parseFailed;
                    throw new Error(Helpers_1.formatError(parseFailed, JSON.stringify(experienceData)));
                }
            }
            else {
...
module.exports = {"client":{"badGaProp":"Tracking ID [placeholder] is not a valid Google Analytics property.","invalidEvent":"[placeholder] is not a valid Imposium event.","badEventRef":"The callback reference passed to [placeholder] was not of type Function.","noCallbackSet":"Please set the following callback: [placeholder]."},"messageConsumer":{"serverFailed":"Something went wrong processing your experience. Try reviewing your configuration.","parseFailed":"Imposium failed to prepare your experience:\n[placeholder]","rejected":"Your experience was rejected."},"videoPlayer":{"badRef":"The video player reference passed to ImposiumClient.setupAnalytics is not of type HTMLVideoElement"}};
...
/*!********************************!*\
  !*** ./src/conf/warnings.json ***!
  \********************************/
/*! exports provided: client, messageConsumer, default */
/***/ (function(module) {

module.exports = {"client":{"nodeAnalytics":"Sorry, analytics are not currently available in NodeJS."},"messageConsumer":{"tcpFailure":"Stomp over TCP failed ([placeholder]): Attempting to reconnect..."}};
