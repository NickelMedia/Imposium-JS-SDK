...
var Analytics = /** @class */ (function () {
    function Analytics(trackingId) {
        this.baseUrl = 'https://ssl.google-analytics.com/collect';
        this.cachedKey = 'imposium_js_ga_cid';
        ...
        this.retries = { current: 0, max: 3, timeout: null, delay: 2000 };
        this.activeRequests = null;
        this.deferredRequests = null;
        this.testReqCount = 0;
        this.trackingId = trackingId;
        this.guid = this.checkCache();
        this.activeRequests = new Queue_1.default();
        this.deferredRequests = new Queue_1.default();
    }
    /*
        Sends events off to the GA collect API
     */
    Analytics.prototype.send = function (event) {
        if (this.activeRequests.isEmpty() && !this.deferRequests)
            this.emit();
    ...
    Analytics.prototype.checkCache = function () {
        try {
            var cache = JSON.parse(localStorage.getItem(this.cachedKey));
            // Check ref val
            if (cache) {
                // check guid expiry
    ...
    Analytics.prototype.concatParams = function (event) {
        var queryString = this.baseUrl + "?v=1&tid=" + this.trackingId + "&z=" + this.getRandom() + "&cid=" + this.guid;
    ...
    Analytics.prototype.emit = function () {
        var _this = this;
        this.reqInterval = setInterval(function () { return _this.makeRequest(); }, this.rate);
    };
    /*
    ...
    Analytics.prototype.scrapeDeferred = function () {
        ...
        if (!this.deferredRequests.isEmpty()) {
            var nReqs = this.deferredRequests.getLength();
    ...
    Analytics.prototype.makeRequest = function () {
        var _this = this;
        var url = this.activeRequests.peek();
        if (url) {
            axios_1.default.get(url)
                .then(function (res) {
                _this.testReqCount++;
                console.log(_this.testReqCount);
                _this.activeRequests.pop();
            })
                .catch(function (err) {
    ...
    Analytics.prototype.retry = function () {
        var _this = this;
        this.retries.timeout = setTimeout(function () {
            if (_this.retries.current < _this.retries.max) {
                _this.retries.delay *= 2;
                _this.retries.current++;
                _this.retry();
            }
            else {
                clearTimeout(_this.retries.timeout);
            }
        }, this.retries.delay);
    };
    return Analytics;
...
var Queue = /** @class */ (function () {
    ...
    Queue.prototype.pop = function (count) {
