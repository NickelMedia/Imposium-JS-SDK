...
var ImposiumClient = /** @class */ (function () {
    ...
    function ImposiumClient(config) {
        ...
        this.createExperience = function (inventory, render) {
            var _a = _this, player = _a.player, _b = _a.eventDelegateRefs, gotExperience = _b.gotExperience, experienceCreated = _b.experienceCreated, uploadProgress = _b.uploadProgress, onError = _b.onError;
            var permitRender = (render && (player || experienceCreated));
