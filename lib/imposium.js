...
var Analytics = /** @class */ (function () {
    function Analytics(trackingId) {
        ...
        this.activeReqs = null;
        this.deferredReqs = null;
        this.testReqCount = 0;
        this.trackingId = trackingId;
        this.guid = this.checkCache();
        this.activeReqs = new Queue_1.default();
        this.deferredReqs = new Queue_1.default();
    }
    /*
        Sends events off to the GA collect API
     */
    Analytics.prototype.send = function (event) {
        if (this.activeReqs.isEmpty() && !this.deferRequests)
            this.emit();
    ...
    Analytics.prototype.scrapeDeferred = function () {
        ...
        if (!this.deferredReqs.isEmpty()) {
            var nReqs = this.deferredReqs.getLength();
    ...
    Analytics.prototype.makeRequest = function () {
        var _this = this;
        var url = this.activeReqs.peek();
        if (url) {
            axios_1.default.get(url)
                .then(function (res) {
                _this.testReqCount++;
                console.log(_this.testReqCount);
                _this.activeReqs.pop();
            })
                .catch(function (err) {
