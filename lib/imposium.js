...
var ImposiumClient = /** @class */ (function () {
    ...
    function ImposiumClient(token, config) {
        ...
        this.createExperience = function (storyId, inventory, render) {
            var experienceCreated = ImposiumEvents_1.default.experienceCreated, uploadProgress = ImposiumEvents_1.default.uploadProgress, onError = ImposiumEvents_1.default.onError;
    ...
    /*
        ...
        video urls / meta
     */
    ImposiumClient.prototype.getVideo = function (job) {
...
var MessageConsumer = /** @class */ (function () {
    ...
    MessageConsumer.prototype.init = function () {
        ...
        Stomp_1.default.setHandlers(function () { return _this.invokeStreaming(); }, function (msg) { return _this.routeMessageData(msg); }, function (e) { return _this.streamError(e); });
    ...
    MessageConsumer.prototype.invokeStreaming = function () {
        var invokeStream = API_1.default.invokeStream;
     ...
     */
    MessageConsumer.prototype.emitMessageData = function (message) {
    ...
    MessageConsumer.prototype.emitSceneData = function (experienceData) {
        var gotScene = ImposiumEvents_1.default.gotScene, onError = ImposiumEvents_1.default.onError;
