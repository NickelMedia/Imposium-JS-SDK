...
var ImposiumClient = /** @class */ (function () {
    ...
    function ImposiumClient(config) {
        ...
        this.assignConfigOpts = function (config) {
            ...
            exports.clientConfig = __assign({}, defaultConfig, config);
            // Prep for analytics in browser
            if (!Helpers_1.isNode()) {
            }
        };
        this.getAnalyticsProperty = function () {
            var storyId = exports.clientConfig.storyId;
            ...
            try {
                if (gotExperience) {
                    API_1.default.getExperience(experienceId)
                        .then(function (data) {
                        var _a = data.experience, id = _a.id, video_url_mp4_720 = _a.video_url_mp4_720;
                        if (_this.cacheVideo) {
                            _this.cacheVideo({
            ...
            try {
                if (permitRender || permitCreate) {
                    ...
                    postExperience(storyId, inventory, uploadProgress)
                        .then(function (data) {
                        var id = data.id;
                        var sceneId = exports.clientConfig.sceneId, actId = exports.clientConfig.actId;
        ...
        this.renderExperience = function (job) {
            var _a = _this, consumer = _a.consumer, cacheVideo = _a.cacheVideo;
            if (!consumer) {
                _this.consumer = new MessageConsumer_1.default(job, cacheVideo);
            }
            else {
                consumer.kill()
                    .then(function () {
...
var MessageConsumer = /** @class */ (function () {
    function MessageConsumer(job, doCacheVideo) {
        if (doCacheVideo === void 0) { doCacheVideo = null; }
        var _this = this;
        this.delegates = {
            start: function () { return _this.invokeStreaming(); },
        ...
        this.establishConnection = function () {
            var _a = _this, expId = _a.job.expId, delegates = _a.delegates;
            _this.stomp = new Stomp_1.default(expId, delegates);
        };
        /*
            Initiates the message queueing process on Imposium related to processing
         */
        this.invokeStreaming = function () {
            var _a = _this.job, expId = _a.expId, sceneId = _a.sceneId, actId = _a.actId;
        ...
        this.routeMessageData = function (msg) {
            var _a = _this, emitMessageData = _a.emitMessageData, emitSceneData = _a.emitSceneData, stomp = _a.stomp;
            var _b = MessageConsumer.EVENT_NAMES, scene = _b.scene, message = _b.message, complete = _b.complete;
            try {
                var payload = JSON.parse(msg.body);
                switch (payload.event) {
                    case complete:
                        stomp.disconnectAsync().then(function () { });
                        break;
                    case message:
         ...
         */
        this.emitSceneData = function (experienceData) {
            var gotExperience = ImposiumEvents_1.default.gotExperience;
        ...
        this.stompError = function (e) {
            var _a = _this, retried = _a.retried, expId = _a.job.expId, stomp = _a.stomp;
...
var Stomp = /** @class */ (function () {
    function Stomp(experienceId, delegates) {
        var _this = this;
        /*
         ...
         */
        this.init = function () {
            var endpoint = Stomp.endpoint, username = Stomp.username, password = Stomp.password;
            var error = _this.delegates.error;
        ...
        this.establishSubscription = function () {
            ...
            var _a = _this, experienceId = _a.experienceId, client = _a.client, _b = _a.delegates, start = _b.start, message = _b.message;
            _this.subscription = client.subscribe("" + exchange + experienceId, message);
            start();
        };
        /*
...
var ImposiumPlayer = /** @class */ (function (_super) {
    ...
    function ImposiumPlayer(node, client, config) {
         ...
         */
        _this.addVideo = function (video, poster) {
            if (poster === void 0) { poster = ''; }
            var _a = _this, videoConfig = _a.videoConfig, videos = _a.videoConfig.videos, node = _a.node;
            var url = video.url;
            videos.push(video);
            if (poster !== _this.videoConfig.poster) {
                _this.videoConfig.poster = poster;
            }
            node.src = url;
        };
        /*
        ...
        try {
            if (client) {
                client.cacheVideo = function (video, poster) { return _this.addVideo(video, poster); };
                _this.init(config);
            }
            else {
...
var VideoPlayer = /** @class */ (function () {
    ...
    function VideoPlayer(node) {
        ...
        this.onLoad = function () {
            var experienceId = _this.experienceId;
         ...
         */
        this.onEnd = function () {
            var _a = _this, experienceId = _a.experienceId, playbackInterval = _a.playbackInterval;
            clearInterval(playbackInterval);
            Analytics_1.default.send({
                t: 'event',
                ec: 'video_player',
        ...
        this.checkPlayback = function () {
            var _a = _this, node = _a.node, prevPlaybackEvent = _a.prevPlaybackEvent, experienceId = _a.experienceId, playbackInterval = _a.playbackInterval;
            if (node) {
