...
var ImposiumClient = /** @class */ (function () {
    ...
    function ImposiumClient(config) {
        ...
        this.assignConfigOpts = function (config) {
            ...
            if (!_this.api || (prevConfig.accessToken !== config.accessToken || prevConfig.environment !== config.environment)) {
        ...
        this.getAnalyticsProperty = function () {
            var _a = _this, api = _a.api, storyId = _a.clientConfig.storyId;
         ...
         */
        this.startMessaging = function (job) {
            var api = _this.api;
            var _a = job.job, expId = _a.expId, sceneId = _a.sceneId, actId = _a.actId;
        ...
        this.renderExperience = function (job) {
            var _a = _this, consumer = _a.consumer, cacheVideo = _a.cacheVideo, environment = _a.clientConfig.environment;
            var startDelegate = function (j) { return _this.startMessaging(j); };
            if (!consumer) {
                _this.consumer = new MessageConsumer_1.default(job, environment, startDelegate, cacheVideo);
            }
            else {
                consumer.kill()
                    .then(function () {
...
var API = /** @class */ (function () {
    function API(authToken, env) {
         ...
         */
        this.invokeStream = function (expId, sceneId, actId) {
            var post = _this.http.post;
            return new Promise(function (resolve, reject) {
                var body = {
                    exp_id: expId,
...
var MessageConsumer = /** @class */ (function () {
    function MessageConsumer(job, env, startDelegate, doCacheVideo) {
        ...
        this.establishConnection = function () {
            var _a = _this, expId = _a.job.expId, env = _a.env, delegates = _a.delegates;
            _this.stomp = new Stomp_1.default(expId, delegates, env);
        };
        /*
...
module.exports = {"client":{"defaultConfig":{"accessToken":"","storyId":"","actId":"","sceneId":"","environment":"production"}},"api":{"production":"https://api.imposium.com","staging":"https://api.staging.imposium.com","hmac":"X-Imposium-Access-Key","jwt":"Authorization"},"messageConsumer":{"maxReconnects":5,"minReconnects":0,"errorOverTcp":"Server failure.","videoSceneKey":"VideoScene01"},"stomp":{"production":"wss://stomp.prod.k8s.nickel.media/ws/","staging":"wss://stomp.staging.k8s.nickel.media/ws","exchange":"/exchange/imposium/","username":"imposium_stomp","password":"Teehe1ceeMe7Pe1d"},"analytics":{"baseUrl":"https://ssl.google-analytics.com/collect","lsLookup":"imposium_js_ga_cid","gaPropPlaceholder":"[id_placeholder]","cidPlaceholder":"[cid_placeholder]","concurrency":10,"frequency":50,"minRetries":0,"maxRetries":3,"minDelay":2000},"videoPlayer":{"defaultConfig":{"volume":1,"preload":"metadata","loop":false,"muted":false,"autoLoad":true,"autoPlay":true,"controls":true},"playbackEvents":[0.25,0.5,0.75],"checkPlaybackRateMs":100,"volumeMin":0,"volumeMax":1}};
