...
var _curry1 = __webpack_require__(11);
var _curry2 = __webpack_require__(9);
var _curryN = __webpack_require__(411);
...
var _isArrayLike = __webpack_require__(400);
var _xwrap = __webpack_require__(401);
...
var _curry2 = __webpack_require__(9);
var _dispatchable = __webpack_require__(419);
var _map = __webpack_require__(421);
var _reduce = __webpack_require__(71);
...
var _undefined = __webpack_require__(367)(); // Support ES3 engines
...
var _isArguments = __webpack_require__(151);
...
var EventEmitter = __webpack_require__(359);
var Analytics_1 = __webpack_require__(375);
var apisauce_1 = __webpack_require__(395);
var MessageConsumer_1 = __webpack_require__(445);
...
var ImposiumClient = /** @class */ (function () {
     ...
     */
    function ImposiumClient(token, trackingId, video, config) {
        if (trackingId === void 0) { trackingId = null; }
        if (video === void 0) { video = null; }
        if (config === void 0) { config = null; }
        var _this = this;
        this.analytics = null;
        this.idRegExp = /^ua-\d{4,9}-\d{1,4}$/i;
        this.video = null;
        this.evts = [0.25, 0.5, 0.75];
        this.lastEvtFired = 0;
        ...
        if (trackingId && (this.idRegExp).test(trackingId)) {
            this.analytics = new Analytics_1.default(trackingId);
            this.pageView();
        ...
        if (video && this.analytics) {
            this.video = video;
            this.video.addEventListener('loadstart', function () { return _this.onLoad(); });
            this.video.addEventListener('play', function () { return _this.onPlay(); });
            this.video.addEventListener('pause', function () { return _this.onPause(); });
            this.video.addEventListener('ended', function () { return _this.onEnd(); });
        }
     ...
     */
    ImposiumClient.prototype.pageView = function () {
     ...
     */
    ImposiumClient.prototype.onLoad = function () {
        this.analytics.send({
            t: 'event',
            ec: 'video_player',
            ea: 'view'
     ...
     */
    ImposiumClient.prototype.onPlay = function () {
        var _this = this;
        clearInterval(this.progressCheckInterval);
        this.progressCheckInterval = setInterval(function () { return _this.checkProgress(); }, 100);
    };
    /*
        Measure video playback percentage record analytics at defined intervals
     */
    ImposiumClient.prototype.checkProgress = function () {
        if (this.video) {
            var perc = this.video.currentTime / this.video.duration, next = this.evts[this.lastEvtFired];
            if (perc > next) {
                this.analytics.send({
                    t: 'event',
                    ec: 'video_player',
     ...
     */
    ImposiumClient.prototype.onPause = function () {
        clearInterval(this.progressCheckInterval);
    };
    /*
        Handle cleaning up once video finishes playing
     */
    ImposiumClient.prototype.onEnd = function () {
        clearInterval(this.progressCheckInterval);
        this.analytics.send({
            t: 'event',
            ec: 'video_player',
     ...
     */
    ImposiumClient.prototype.copy = function (a, b) {
        for (var key in b) {
    ...
    ImposiumClient.prototype.createExperience = function (storyId, inventory, render, success, error, progress) {
        ...
        var data = this.formatData(storyId, inventory, error), config = (progress) ? { onUploadProgress: function (e) { return progress(e); } } : {};
        this.api.post('/experience', data, config)
            .then(function (res) {
            if (res.ok) {
                if (_this.analytics) {
                    _this.analytics.send({
                        t: 'event',
                        ec: 'experience',
                        ea: 'created',
                        el: res.data.id
    ...
    /*
        ...
        video urls / meta
     */
    ImposiumClient.prototype.getVideo = function (job, success, error) {
        var jobSpec = {
            'expId': job.expId,
            'actId': job.actId,
            'sceneId': job.sceneId,
            'onSuccess': success,
            'onError': error
        }, stompConfig = ImposiumClient.config.stompConfig;
        if (!this.messageConsumer) {
            this.messageConsumer = new MessageConsumer_1.MessageConsumer(jobSpec, stompConfig, this, this.api);
        }
        else {
...
var _curry2 = __webpack_require__(9);
var _equals = __webpack_require__(428);
...
var d        = __webpack_require__(360)
  , callable = __webpack_require__(374)
...
var assign        = __webpack_require__(361)
  , normalizeOpts = __webpack_require__(369)
  , isCallable    = __webpack_require__(370)
...
var isValue = __webpack_require__(101);
...
Object.defineProperty(exports, "__esModule", { value: true });
var axios_1 = __webpack_require__(142);
...
var Analytics = /** @class */ (function () {
    function Analytics(trackingId) {
        ...
        var _a = this.request, appId = _a.appId, clientId = _a.clientId;
        appId = trackingId;
    ...
    Analytics.prototype.send = function (event) {
        var _a = this.broker, defer = _a.defer, active = _a.active;
     ...
     */
    Analytics.prototype.checkCache = function () {
        var cacheKey = this.request.cacheKey;
        try {
     ...
     */
    Analytics.prototype.setCache = function (guid) {
        try {
            var cacheKey = this.request.cacheKey, cache = { guid: null, expiry: null }, expiry = new Date();
            cache.guid = guid;
     ...
     */
    Analytics.prototype.s4 = function () {
        return Math.floor((1 + Math.random()) * 0x10000).toString(16).substring(1);
    };
    /*
        Concatenate a new guid
     */
    Analytics.prototype.generateGuid = function () {
        return "" + this.s4() + this.s4() + "-" + this.s4() + "-" + this.s4() + "-" + this.s4() + "-" + this.s4() + this.s4() + this.s4();
    };
    /*
        Get a random number to supply the caching buster parameter
     */
    Analytics.prototype.getRandom = function () {
     ...
     */
    Analytics.prototype.concatParams = function (event) {
        var _a = this.request, baseUrl = _a.baseUrl, appId = _a.appId, clientId = _a.clientId;
        var queryString = baseUrl + "?v=1&tid=" + appId + "&z=" + this.getRandom() + "&cid=" + clientId;
     ...
     */
    Analytics.prototype.emit = function () {
        var _this = this;
        var frequency = this.broker.frequency;
        this.emitter = setInterval(function () { return _this.setRequestUrl(); }, frequency);
    };
    /*
        Determine if request needs to be deferred during a burst
     */
    Analytics.prototype.addToQueue = function (url) {
        var _a = this.broker, concurrency = _a.concurrency, defer = _a.defer, active = _a.active, deferred = _a.deferred;
        if (!defer) {
            active.enqueue(url);
     ...
     */
    Analytics.prototype.scrapeDeferred = function () {
        var _a = this.broker, concurrency = _a.concurrency, enqueued = _a.enqueued, defer = _a.defer, active = _a.active, deferred = _a.deferred;
        if (!deferred.isEmpty()) {
            var limit = 0;
    ...
    /*
        ...
        enable retries.
     */
    Analytics.prototype.setRequestUrl = function (failedUrl) {
        if (failedUrl === void 0) { failedUrl = null; }
        if (failedUrl) {
            this.makeRequest(failedUrl);
        }
        else {
            var active = this.broker.active, url = active.peek();
            if (url) {
                active.pop();
     ...
     */
    Analytics.prototype.makeRequest = function (url) {
        var _this = this;
        axios_1.default.get(url)
            .then(function (res) {
            var active = _this.broker.active;
            if (active.isEmpty()) {
                clearInterval(_this.emitter);
            }
        })
            .catch(function (err) {
            clearInterval(_this.emitter);
    ...
    /*
        ...
        Retry interface.
     */
    Analytics.prototype.retry = function (url) {
        var _this = this;
        var active = this.broker.active;
        var _a = this.retries, current = _a.current, max = _a.max, delay = _a.delay;
        this.retryTimeout = setTimeout(function () {
            if (current < max) {
                delay *= 2;
                current++;
                _this.setRequestUrl(url);
            }
            else {
...
var _concat = __webpack_require__(149);
var _createPartialApplicator = __webpack_require__(397);
...
var _arity = __webpack_require__(49);
var _pipe = __webpack_require__(399);
var reduce = __webpack_require__(103);
var tail = __webpack_require__(403);
...
var _curry1 = __webpack_require__(11);
var _isArray = __webpack_require__(72);
var _isString = __webpack_require__(150);
...
var _checkForMethod = __webpack_require__(104);
var _curry1 = __webpack_require__(11);
var slice = __webpack_require__(404);
...
var lift = __webpack_require__(416);
var not = __webpack_require__(424);
...
var _curry1 = __webpack_require__(11);
var liftN = __webpack_require__(417);
...
var _curry2 = __webpack_require__(9);
var _reduce = __webpack_require__(71);
var ap = __webpack_require__(418);
var curryN = __webpack_require__(55);
...
var _isArray = __webpack_require__(72);
var _isTransformer = __webpack_require__(420);
...
var _curry2 = __webpack_require__(9);
var _xfBase = __webpack_require__(423);
...
var _curry1 = __webpack_require__(11);
var empty = __webpack_require__(426);
...
var _isArguments = __webpack_require__(151);
var _isArray = __webpack_require__(72);
var _isObject = __webpack_require__(427);
var _isString = __webpack_require__(150);
...
var _arrayFromIterator = __webpack_require__(429);
var _functionName = __webpack_require__(430);
var _has = __webpack_require__(54);
var identical = __webpack_require__(431);
var keys = __webpack_require__(105);
var type = __webpack_require__(432);
...
var _curry1 = __webpack_require__(11);
var curryN = __webpack_require__(55);
var max = __webpack_require__(156);
var pluck = __webpack_require__(434);
var reduce = __webpack_require__(103);
...
var _curry2 = __webpack_require__(9);
var map = __webpack_require__(73);
var prop = __webpack_require__(152);
...
var _indexOf = __webpack_require__(437);
...
Object.defineProperty(exports, "__esModule", { value: true });
var ImposiumClient_1 = __webpack_require__(106);
var StompClient_1 = __webpack_require__(446);
var MessageConsumer = /** @class */ (function () {
    function MessageConsumer(job, config, delegate, api) {
        this.retried = 0;
        this.maxRetries = 3;
        this.job = job;
     ...
     */
    MessageConsumer.prototype.setJob = function (job) {
        this.job = __assign({}, job);
    };
    /*
        Set the context for the event listener
     */
    MessageConsumer.prototype.setContext = function (ctx) {
        this.delegate = ctx;
    };
    /*
        Initialize WebStomp
     */
    MessageConsumer.prototype.init = function (config) {
        var _this = this;
        config.onError = this.onError = function (e) { return _this.streamError(e); };
        config.onMessage = this.onMessage = function (msg) { return _this.router(msg); };
        config.onConnect = function () {
            _this.invokeStreaming();
        };
        this.stompClient = new StompClient_1.StompClient(config, this.job.expId);
    };
    /*
        Sets up a websocket for the experience
     */
    MessageConsumer.prototype.reconnect = function (config) {
        var _this = this;
    ...
    MessageConsumer.prototype.invokeStreaming = function () {
        var _this = this;
        var endpoint = "/experience/" + this.job.expId + "/trigger-event", body = {
        ...
        this.api.post(endpoint, body)
            .then(function (res) {
            if (!res.ok)
                _this.job.onError(res.data);
        }).catch(function (err) {
            _this.job.onError(err);
        });
    };
    /*
        ...
        may be terminated.
     */
    MessageConsumer.prototype.router = function (msg) {
     ...
     */
    MessageConsumer.prototype.gotMessage = function (payload) {
        if (payload)
            this.delegate.emit(ImposiumClient_1.events.STATUS, payload);
    };
    /*
        Parse the scene data and propagate if there aren't errors.
        If any error occurs, propagate the error.
     */
    MessageConsumer.prototype.gotScene = function (payload) {
        if (payload.output) {
            if (payload.output[payload.sceneData.id].mp4Url) {
                var sceneData = void 0;
                if (payload.hasOwnProperty('output')) {
                    if (typeof payload.output != 'undefined') {
                        for (var key in payload.output) {
    ...
    /*
        ...
        based on config.
     */
    MessageConsumer.prototype.streamError = function (err) {
        if (!err.wasClean) {
            ++this.retried;
...
Object.defineProperty(exports, "__esModule", { value: true });
var WebStomp = __webpack_require__(447);
var StompClient = /** @class */ (function () {
    function StompClient(config, expId) {
        this.config = config;
        this.expId = expId;
        this.init();
    }
     ...
     */
    StompClient.prototype.kill = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
    ...
    StompClient.prototype.init = function () {
        ...
        this.client.connect(this.config.user, this.config.password, this.subscribe = function () { return _this.establishSubscription(); }, this.config.onError);
    };
    /*
        Subscribes to a queue on the base imposium exchange
        then invokes message consumption
     */
    StompClient.prototype.establishSubscription = function () {
        this.subscription = this.client.subscribe("" + this.config.exchangeRoute + this.expId, this.config.onMessage);
