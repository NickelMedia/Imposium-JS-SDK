...
var Analytics = /** @class */ (function () {
    ...
    Analytics.setup = function (trackingId) {
        ...
        if (!Analytics.isSetup) {
            var preLoaded = Analytics.broker.preLoaded;
...
var Stomp_1 = __webpack_require__(/*! ./tcp/Stomp */ "./src/client/tcp/Stomp.ts");
...
var Playback_1 = __webpack_require__(/*! ../video/Playback */ "./src/video/Playback.ts");
...
var ImposiumEvents_1 = __webpack_require__(/*! ./ImposiumEvents */ "./src/client/ImposiumEvents.ts");
...
var warnings = __webpack_require__(/*! ../conf/warnings.json */ "./src/conf/warnings.json").client;
var errors = __webpack_require__(/*! ../conf/errors.json */ "./src/conf/errors.json").client;
var ImposiumClient = /** @class */ (function () {
    ...
    function ImposiumClient(config) {
        ...
        this.assignConfigOpts = function (config) {
            ...
            settings.activeConfig = __assign({}, defaultConfig, config);
            var _a = settings.activeConfig, accessToken = _a.accessToken, environment = _a.environment, storyId = _a.storyId;
            API_1.default.setup(accessToken, environment);
            Stomp_1.default.setEndpoint(environment);
            // Prep for analytics in browser
            if (!Helpers_1.isNode()) {
                API_1.default.getStory(storyId)
                    .then(function (story) {
                    // GA prop regExp
                    // RegExp(/^ua-\d{4,9}-\d{1,4}$/i) 
                    var GaProp = 'UA-113079866-1';
                    Analytics_1.default.setup(GaProp);
                })
                    .catch(function (e) {
                    console.error(e);
                });
            ...
            try {
                if (Helpers_1.isFunc(callback)) {
                    if (Helpers_1.keyExists(_this.events, eventName)) {
                        ...
                        throw new Exceptions_1.ConfigurationError('invalidEventName', eventName);
                    }
                }
                else {
                    throw new Exceptions_1.ConfigurationError('invalidCallbackType', eventName);
                }
            }
            catch (e) {
                ExceptionPipe_1.default.routeError(e);
            }
        };
        /*
            ...
            try {
                if (gotExperience) {
                    API_1.default.getExperience(expId)
                        .then(function (data) {
                        var id = data.experience.id;
                        Playback_1.default.updateExperience(id);
                        gotExperience(data);
                    })
                        .catch(function (e) {
                        var wrappedError = new Exceptions_1.NetworkError('httpFailure', e);
                        ExceptionPipe_1.default.routeError(wrappedError);
                    });
                }
                else {
                    throw new Exceptions_1.ConfigurationError('eventNotConfigured', _this.events.GOT_EXPERIENCE);
                }
            }
            catch (e) {
                ExceptionPipe_1.default.routeError(e);
        ...
        this.createExperience = function (inventory, render) {
            var gotExperience = ImposiumEvents_1.default.gotExperience, experienceCreated = ImposiumEvents_1.default.experienceCreated, uploadProgress = ImposiumEvents_1.default.uploadProgress;
            var permitRender = (render && experienceCreated);
            var permitCreate = (!render && gotExperience);
            try {
                if (permitRender || permitCreate) {
                    var storyId = settings.activeConfig.storyId;
                    var postExperience = API_1.default.postExperience;
                    postExperience(storyId, inventory, uploadProgress)
                        .then(function (data) {
                        var id = data.id;
                        var _a = settings.activeConfig, sceneId = _a.sceneId, actId = _a.actId;
                        if (experienceCreated) {
                            experienceCreated(data);
                        }
                        if (render) {
                            _this.renderExperience({
                                expId: id,
                                sceneId: sceneId,
                                actId: actId
                            });
                    ...
                    var noCallbackSet = errors.noCallbackSet;
                    var eventType = null;
                    if (render && !gotExperience) {
                        eventType = _this.events.GOT_EXPERIENCE;
                    }
                    if (!render && !experienceCreated) {
                        eventType = _this.events.EXPERIENCE_CREATED;
                    }
                    throw new Exceptions_1.ConfigurationError('eventNotConfigured', eventType);
                }
            }
            catch (e) {
                ExceptionPipe_1.default.routeError(e);
         ...
         */
        this.renderExperience = function (job) {
            var expId = job.expId;
            Playback_1.default.updateExperience(expId);
        ...
        this.captureAnalytics = function (playerRef) {
            ...
            try {
                if (!Helpers_1.isNode()) {
                    _this.fallbackPlayer = new FallbackPlayer_1.default(playerRef);
                }
                else {
...
exports.default = ImposiumClient;


/***/ }),

/***/ "./src/client/ImposiumEvents.ts":
/*!**************************************!*\
  !*** ./src/client/ImposiumEvents.ts ***!
  \**************************************/
/*! no static exports found */
...
var ImposiumEvents = /** @class */ (function () {
    ...
    ImposiumEvents.statusUpdate = null;
...
var API = /** @class */ (function () {
     ...
     */
    API.setup = function (authToken, env) {
    ...
    API.postExperience = function (storyId, inventory, progress) {
        ...
        var doPostExperience = API.doPostExperience, uploadProgress = API.uploadProgress;
    ...
    API.uploadProgress = function (e, callback) {
...
var Exceptions_1 = __webpack_require__(/*! ../../scaffolding/Exceptions */ "./src/scaffolding/Exceptions.ts");
var Helpers_1 = __webpack_require__(/*! ../../scaffolding/Helpers */ "./src/scaffolding/Helpers.ts");
var warnings = __webpack_require__(/*! ../../conf/warnings.json */ "./src/conf/warnings.json").messageConsumer;
...
var MessageConsumer = /** @class */ (function () {
    ...
    MessageConsumer.maxRetries = settings.maxReconnects;
    MessageConsumer.retried = settings.minReconnects;
    /*
        Initialize WebStomp
     */
    ...
    MessageConsumer.reconnect = function (job) {
        Stomp_1.default.disconnectAsync()
            ...
            var wrappedError = new Exceptions_1.NetworkError('tcpFailure', e);
            ExceptionPipe_1.default.routeError(wrappedError);
        });
    };
    /*
    ...
    MessageConsumer.routeMessageData = function (msg) {
        ...
        try {
            ...
            var wrappedError = new Exceptions_1.NetworkError('messageParseFailed', e);
            ExceptionPipe_1.default.routeError(wrappedError);
        }
    };
    /*
    ...
    MessageConsumer.emitMessageData = function (messageData) {
        var statusUpdate = ImposiumEvents_1.default.statusUpdate;
        var msg = messageData.msg;
        try {
            if (msg === settings.errorOverTcp) {
                throw new Exceptions_1.NetworkError('errorOverTcp', null);
            }
            if (statusUpdate) {
    ...
    MessageConsumer.emitSceneData = function (experienceData) {
        ...
        try {
            if (!rejected) {
                ...
                var isVideo = (((experienceData || {}).sceneData || {}).type === settings.videoSceneKey);
                if (isVideo && hasUrls) {
                    ...
                    throw new Exceptions_1.NetworkError('messageParseFailed', null);
                }
            }
            else {
                throw new Exceptions_1.ModerationError('rejection');
            }
        }
        catch (e) {
    ...
    MessageConsumer.stompError = function (e) {
        ...
        if (!e.wasClean) {
            ...
            if (retried < maxRetries) {
                var tcpFailure = warnings.tcpFailure;
                Stomp_1.default.reconnect(expId);
                Helpers_1.warnHandler(Helpers_1.formatError(tcpFailure, retried + 1));
            }
            else {
...
var Stomp = /** @class */ (function () {
    ...
    Stomp.setEndpoint = function (env) {
...
/*!******************************!*\
  !*** ./src/conf/errors.json ***!
  \******************************/
/*! exports provided: environment, moderation, configuration, network, default */
/***/ (function(module) {

module.exports = {"environment":{"node":"Sorry, this feature is incompatible with NodeJS"},"moderation":{"rejection":"This experience was rejected."},"configuration":{"invalidEventName":"Invalid Imposium event, please review your configuration.","invalidCallbackType":"You did not pass in a function reference for this event, please review your configuration.","eventNotConfigured":"You cannot invoke this event without a callback set, please review your configuration.","invalidPlayerRef":"No reference to an HTML5 video element was detected, please review your configuration."},"network":{"httpFailure":"Unable to process request to the Imposium API.","tcpFailure":"Unable to reach Imposium while processing this experience.","errorOverTcp":"Something went wrong while processing this experience.","messageParseFailure":"Message data from Imposium was malformed."}};
...
module.exports = {"client":{"defaultConfig":{"accessToken":"","storyId":"","actId":"","sceneId":"","environment":"production"},"activeConfig":{}},"api":{"prodBaseUrl":"https://api.imposium.com","stagingBaseUrl":"https://api.staging.imposium.com","hmac":"X-Imposium-Access-Key","jwt":"Authorization"},"messageConsumer":{"maxReconnects":5,"minReconnects":0,"errorOverTcp":"Server failure.","videoSceneKey":"VideoScene01"},"stomp":{"prodEndpoint":"wss://stomp.prod.k8s.nickel.media/ws","stagingEndpoint":"wss://stomp.staging.k8s.nickel.media/ws","exchange":"/exchange/imposium/","username":"imposium_stomp","password":"Teehe1ceeMe7Pe1d"},"analytics":{"baseUrl":"https://ssl.google-analytics.com/collect","lsLookup":"imposium_js_ga_cid","gaPropPlaceholder":"[id_placeholder]","cidPlaceholder":"[cid_placeholder]","concurrency":10,"frequency":50,"minRetries":0,"maxRetries":3,"minDelay":2000},"videoPlayer":{"defaultConfig":{"volume":1,"preload":"metadata","loop":false,"muted":false,"autoLoad":true,"autoPlay":true,"controls":true},"activeConfig":{},"playbackEvents":[0.25,0.5,0.75],"checkPlaybackRateMs":100,"volumeMin":0,"volumeMax":1}};
...
/*!********************************!*\
  !*** ./src/conf/warnings.json ***!
  \********************************/
/*! exports provided: client, messageConsumer, videoPlayer, default */
/***/ (function(module) {

module.exports = {"client":{"nodeAnalytics":"Sorry, analytics are not currently available in NodeJS."},"messageConsumer":{"tcpFailure":"Stomp over TCP failed ([placeholder]): Attempting to reconnect..."},"videoPlayer":{"seekNotReady":"Video player does not have enough data to seek yet.","badSeek":"Video player cannot seek to this time."}};
...
Object.defineProperty(exports, "__esModule", { value: true });
var ImposiumClient_1 = __webpack_require__(/*! ./client/ImposiumClient */ "./src/client/ImposiumClient.ts");
exports.ImposiumClient = ImposiumClient_1.default;
var ImposiumPlayer_1 = __webpack_require__(/*! ./video/ImposiumPlayer */ "./src/video/ImposiumPlayer.ts");
exports.ImposiumPlayer = ImposiumPlayer_1.default;
...
Object.defineProperty(exports, "__esModule", { value: true });
var ImposiumEvents_1 = __webpack_require__(/*! ../client/ImposiumEvents */ "./src/client/ImposiumEvents.ts");
var ExceptionPipe = /** @class */ (function () {
    function ExceptionPipe() {
    }
    ExceptionPipe.routeError = function (e, breakFlow) {
        if (breakFlow === void 0) { breakFlow = true; }
...
var ModerationError = /** @class */ (function (_super) {
    ...
    function ModerationError(messageKey, type) {
        if (type === void 0) { type = types.MODERATION; }
        var _this = _super.call(this, errors[type][messageKey], type) || this;
        _this.log = function () {
...
var ConfigurationError = /** @class */ (function (_super) {
    ...
    function ConfigurationError(messageKey, eventName, type) {
        if (type === void 0) { type = types.CONFIG; }
        var _this = _super.call(this, errors[type][messageKey], type) || this;
        _this.eventName = '';
        _this.log = function () {
        ...
        if (Error.captureStackTrace) {
            Error.captureStackTrace(_this, ConfigurationError);
        }
...
var NetworkError = /** @class */ (function (_super) {
    ...
    function NetworkError(messageKey, networkError, type) {
...
var warnings = __webpack_require__(/*! ../conf/warnings.json */ "./src/conf/warnings.json").videoPlayer;
exports.ImposiumPlayerEvents = {
...
var ImposiumPlayer = /** @class */ (function (_super) {
    ...
    function ImposiumPlayer(node, config) {
        ...
        _this.init = function (config) {
            var defaultConfig = settings.defaultConfig;
            Helpers_1.prepConfig(config, defaultConfig);
            ImposiumPlayer.ImposiumPlayerConfig = __assign({}, defaultConfig, config);
            for (var key in ImposiumPlayer.ImposiumPlayerConfig) {
        ...
        _this.on = function (eventName, callback) {
            try {
                if (Helpers_1.isFunc(callback)) {
                    if (Helpers_1.keyExists(_this.events, eventName)) {
                        var event_1 = exports.ImposiumPlayerEvents[eventName];
                        ...
                        if (event_1.native) {
                            ImposiumPlayer.node.addEventListener(eventName, event_1.callback);
                        }
                    }
                    else {
                    }
        ...
        _this.off = function (eventName) {
            try {
                if (Helpers_1.keyExists(_this.events, eventName)) {
                    var event_2 = exports.ImposiumPlayerEvents[eventName];
                    // Remove node based event listener
                    if (event_2.native) {
                        ImposiumPlayer.node.removeEventListener(eventName, event_2.callback);
                    }
        ...
        _this.seek = function (seekTo, retry) {
            ...
            var duration = ImposiumPlayer.node.duration;
            if (!isNaN(duration)) {
                if (Helpers_1.inRangeNumeric(seekTo, 0, duration)) {
                    ImposiumPlayer.node.currentTime = seekTo;
                }
                else {
                    var badSeek = warnings.badSeek;
                    Helpers_1.warnHandler(badSeek);
                }
            }
            else {
                var seekNotReady = warnings.seekNotReady;
                Helpers_1.warnHandler(seekNotReady);
            }
        };
        /*
            Get mute state
        ...
        _this.setMute = function (mute) {
            var muted = exports.ImposiumPlayerEvents.muted;
        ...
        _this.setControls = function (controls) {
            var controlsset = exports.ImposiumPlayerEvents.controlsset;
        ...
        _this.remove = function () {
            var defaultConfig = settings.defaultConfig;
            _this.pauseIfPlaying();
            for (var key in exports.ImposiumPlayerEvents) {
                _this.off(exports.ImposiumPlayerEvents[key]);
            }
            ImposiumPlayer.ImposiumPlayerConfig = __assign({}, defaultConfig);
    ...
    ImposiumPlayer.ImposiumPlayerConfig = null;
...
var Playback = /** @class */ (function () {
    ...
    Playback.intervalRate = settings.checkPlaybackRateMs;
    Playback.playbackEvents = settings.playbackEvents;
    Playback.mediaEvents = {
        loadstart: function () { return Playback.onLoad(); },
        play: function () { return Playback.onPlay(); },
        pause: function () { return Playback.onPause(); },
        ended: function () { return Playback.onEnd(); }
    };
    Playback.playerRef = null;
    Playback.experienceId = '';
    Playback.prevPlaybackEvent = 0;
    Playback.setPlayerRef = function (ref) {
        Playback.playerRef = ref;
        for (var key in Playback.mediaEvents) {
            Playback.playerRef.addEventListener(key, Playback.mediaEvents[key]);
        }
    };
    Playback.updateExperience = function (experienceId) {
        Playback.experienceId = experienceId;
    };
    Playback.onLoad = function () {
        var experienceId = Playback.experienceId;
    ...
    Playback.onPlay = function () {
        var intervalRate = Playback.intervalRate, playbackInterval = Playback.playbackInterval;
        clearInterval(playbackInterval);
        Playback.playbackInterval = setInterval(function () { return Playback.checkPlayback(); }, intervalRate);
    };
    Playback.onPause = function () {
        var playbackInterval = Playback.playbackInterval;
        clearInterval(playbackInterval);
    };
    Playback.onEnd = function () {
        var experienceId = Playback.experienceId, playbackInterval = Playback.playbackInterval;
        clearInterval(playbackInterval);
        Analytics_1.default.send({
            t: 'event',
            ec: 'video_player',
    ...
    Playback.checkPlayback = function () {
        var playerRef = Playback.playerRef, playbackEvents = Playback.playbackEvents, prevPlaybackEvent = Playback.prevPlaybackEvent, experienceId = Playback.experienceId, playbackInterval = Playback.playbackInterval;
        if (playerRef) {
            var currentTime = playerRef.currentTime, duration = playerRef.duration;
            var perc = currentTime / duration;
            var next = playbackEvents[prevPlaybackEvent];
            if (perc > next) {
                Analytics_1.default.send({
                    t: 'event',
                    ec: 'video_player',
...
Object.defineProperty(exports, "__esModule", { value: true });
var Playback_1 = __webpack_require__(/*! ./Playback */ "./src/video/Playback.ts");
var Exceptions_1 = __webpack_require__(/*! ../scaffolding/Exceptions */ "./src/scaffolding/Exceptions.ts");
var Helpers_1 = __webpack_require__(/*! ../scaffolding/Helpers */ "./src/scaffolding/Helpers.ts");
    ...
    function VideoPlayer(node) {
        ...
        if (!Helpers_1.isNode()) {
            if (node instanceof HTMLVideoElement) {
                ...
                Playback_1.default.setPlayerRef(VideoPlayer.node);
            }
            else {
                // Prop passed wasn't of type HTMLVideoElement
                throw new Exceptions_1.ConfigurationError('invalidPlayerRef', null);
            }
        }
        else {
