...
var _xmap = __webpack_require__(101);
...
var apisauce_1 = __webpack_require__(74);
var EventEmitter = __webpack_require__(143);
var MessageConsumer_1 = __webpack_require__(221);
...
var ImposiumClient = /** @class */ (function () {
    ...
    ImposiumClient.prototype.createExperience = function (storyId, inventory, render, success, error, progress) {
        ...
        var data = { 'story_id': storyId, 'inventory': inventory };
    ...
    ImposiumClient.prototype.startEventProcessor = function (data, success, error) {
        ...
        if (!this.messageConsumer) {
            this.messageConsumer = new MessageConsumer_1.MessageConsumer(jobSpec, this, this.api, this.stompConfig);
        }
        else {
...
var _curry2 = __webpack_require__(0);
var _equals = __webpack_require__(107);
...
var _createPartialApplicator = __webpack_require__(76);
...
var _arity = __webpack_require__(7);
var _pipe = __webpack_require__(78);
...
var _isArray = __webpack_require__(15);
var _isTransformer = __webpack_require__(99);
...
var _arrayFromIterator = __webpack_require__(108);
var _functionName = __webpack_require__(109);
var _has = __webpack_require__(9);
var identical = __webpack_require__(110);
var keys = __webpack_require__(23);
...
var pluck = __webpack_require__(113);
var reduce = __webpack_require__(21);
...
Object.defineProperty(exports, "__esModule", { value: true });
var WebStomp = __webpack_require__(159);
/**
...
var StompClient = /** @class */ (function () {
    ...
    StompClient.prototype.init = function () {
        ...
        this.client.connect(this.config.stompUser, this.config.stompPass, this.subscribe = function () { return _this.establishSubscription(); }, this.config.onError);
    };
    /**
...
Object.defineProperty(exports, "__esModule", { value: true });
var ImposiumClient_1 = __webpack_require__(26);
var StompClient_1 = __webpack_require__(219);
/**
...
var MessageConsumer = /** @class */ (function () {
     ...
     * @param {StompConfig} config   WebStomp config
     */
    function MessageConsumer(job, delegate, api, config) {
        this.retried = 0;
        this.maxRetries = 3;
        this.job = job;
    ...
    MessageConsumer.prototype.gotScene = function (payload) {
        ...
        if (sceneData) {
            if (this.job.onSuccess) {
                this.delegate = (function () { return _this.job.onSuccess(sceneData); })();
            }
        }
        else {
            if (this.job.onError) {
                this.delegate = (function () { return _this.job.onError(sceneData); })();
            }
        }
    };
    /**
