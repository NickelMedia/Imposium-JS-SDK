...
Object.defineProperty(exports, "__esModule", { value: true });
var Analytics_1 = __webpack_require__(/*! ./Analytics */ "./src/analytics/Analytics.ts");
...
var VideoPlayer = /** @class */ (function () {
    ...
    // Interval data
    VideoPlayer.evts = settings.playbackEvents;
    VideoPlayer.checkRate = settings.checkPlaybackRateMs;
    ...
    VideoPlayer.onPlay = function () {
        var checkRate = VideoPlayer.checkRate, checkProgress = VideoPlayer.checkProgress, progressCheckInterval = VideoPlayer.progressCheckInterval;
        clearInterval(progressCheckInterval);
        VideoPlayer.progressCheckInterval = setInterval(function () { return checkProgress(); }, checkRate);
    };
    /*
...
var VideoPlayer_1 = __webpack_require__(/*! ../analytics/VideoPlayer */ "./src/analytics/VideoPlayer.ts");
            ...
            try {
                if (gotExperience) {
                    API_1.default.getExperience(expId)
                        ...
                        VideoPlayer_1.default.updateExperienceID(data.experience.id);
                        gotExperience(data);
                    })
                        .catch(function (e) {
                        Helpers_1.errorHandler(e);
